...
export const metadata: Metadata = {
  title: 'Privacy Policy | Omor Auto Corner',
  description: 'Learn how Omor Auto Corner collects, uses, and protects your personal information.',
};
...
export default async function PrivacyPage() {
  ...
  const contactEmail = settings.contact?.email || "support@omorautocorner.com";
